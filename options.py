...
parser.add_argument('--lr_d_coef', type=float, default=1., help='learning rate coefficient of discriminators.')
parser.add_argument('--lr_g_coef', type=float, default=1., help='learning rate coefficient of generators.')
